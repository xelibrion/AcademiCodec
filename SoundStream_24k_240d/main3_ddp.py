...
def get_args():
    ...
    parser.add_argument("--PATH", type=str, default="model_path/", help="model_path")
    ...
    parser.add_argument("--train_data_path", type=str, default="", help="training data")
    parser.add_argument("--valid_data_path", type=str, default="", help="training data")
...
def main_worker(local_rank, args):
    ...
    if args.distributed:
        ...
        stft_disc = DDP(
            stft_disc, device_ids=[args.local_rank], find_unused_parameters=True
        )
    ...
    optimizer_g = torch.optim.AdamW(
        soundstream.parameters(), lr=DEFAULT_LR, betas=(0.5, 0.9)
    )
